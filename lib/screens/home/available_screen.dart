...
class AvailableScreen extends StatefulWidget {
  ...
  AvailableScreen({super.key, required this.userSelectedTo, required this.userSelectedFrom});
...
class _AvailableScreenState extends State<AvailableScreen> {
  ...
  void initState() {
    context.read<AuthNotifier>().fetchAvailableDrivers(
        context, latitude: widget.userSelectedFrom.latitude ?? "0.0",
    ...
    return Consumer<AuthNotifier>(
      builder: (context, AuthNotifier auth, child) =>
          Scaffold(
            ...
            body: SafeArea(
              child:
              auth.isLoading && auth.drivers.isEmpty ? Center(
                    ...
                    ElevatedButton(
                        ...
                        onPressed: () async {
                          await auth.fetchAvailableDrivers(
                              context, radius: 100000,
                              latitude: widget.userSelectedFrom.latitude ??
                                  "0.0",
                              longitude: widget.userSelectedFrom.longitude ??
                                  "0.0");
                        },
                      ...
                      children: [
                        ...
                        ListTile(
                            ...
                            leading: CircleAvatar(
                              ...
                              radius: 18,
                              child: driver.profileImage == null || driver
                            ...
                            trailing: Container(
                                ...
                                child: InkWell(
                                  onTap:(){
                                    _showDriverTripDetails(context, driver, BookRideDto(driverId: driver.userId, riderToLong:double.parse(widget.userSelectedTo.longitude ?? "0.0"), riderToLat: double.parse(widget.userSelectedTo.latitude ?? "0.0"), riderFromLong: double.parse(widget.userSelectedFrom.longitude ?? "0.0"), driverLongitude: double.parse(driver.latitude ?? "0.0"), driverLatitude: double.parse(driver.longitude ?? "0.0"), riderFromAddress: widget.userSelectedFrom.address, riderToAddress: widget.userSelectedTo.address, amount: 0));
                                  },
                                  child: const Text(
                                    "Book Now",
  ...
  void _showDriverTripDetails(BuildContext context, AvailableDriver driver, BookRideDto payload) {
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    ListTile(
                      ...
                      title: Text('${driver.firstName} ${driver.lastName}', style: TextStyle(fontSize: 18)),
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Text('${widget.userSelectedTo.address}', style: TextStyle(fontSize: 16)),
                      ],
                    ),
                    SizedBox(height: 10),
                    Row(
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Text('${widget.userSelectedTo.distance} km', style: TextStyle(fontSize: 16)),
                      ],
                    ),
                    // SizedBox(height: 10),
                    // Row(
